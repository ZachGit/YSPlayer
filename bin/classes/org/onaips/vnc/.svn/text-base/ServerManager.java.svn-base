...
public class ServerManager extends Service {
	...
	public void startServer() {
		...
		try {
			...
			if (!preferences.getString("displaymode", "auto").equals("auto") && currentapiVersion > 4.0)
			...
			root =true;
			Log.e("dongpuxiao", "server_string+server_string"+server_string);
			if (root)     
			{ 
				Log.e("dongpuxiao","Running as root...");
				log("Running as root...");
			...
			{
				Log.e("dongpuxiao","Not running as root...");
